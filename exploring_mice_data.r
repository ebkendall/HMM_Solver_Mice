file_names = c("Mouse_Data/WT 08 20210309 03 Penetrating Arteriole 064 ECoG, EMG and sleep.csv",
               "Mouse_Data/WT 08 20210311 06 Penetrating Arteriole 065 ECoG, EMG and sleep.csv",
               "Mouse_Data/WT 08 20210311 10 Penetrating Arteriole 066 ECoG, EMG and sleep.csv",
               "Mouse_Data/WT 09 20210308 03 Penetrating Arteriole 073 ECoG, EMG and sleep.csv")
